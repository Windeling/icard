      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8">
          ...
          <div className="bg-[#f5f5f7] rounded-3xl overflow-hidden">
            <div className="p-8 md:p-10">
              <div className="flex flex-col md:flex-row items-center md:items-start mb-6">
                ...
                />
                <div>
                  <h3 className="text-2xl font-semibold mb-2">iCard挂绳</h3>
                  <p className="text-gray-600">
                    无与伦比的安全和防丢失体验，保护你的iCard不受意外失踪
                  </p>
                </div>
              </div>
          ...
          <div className="bg-[#f5f5f7] rounded-3xl overflow-hidden">
            <div className="p-8 md:p-10">
              <div className="flex flex-col md:flex-row items-center md:items-start mb-6">
                ...
                />
                <div>
                  <h3 className="text-2xl font-semibold mb-2">适用于 iCard 的保护套</h3>
                  <p className="text-gray-600">
                    保护套与挂绳的完美结合，带来日常级的iCard体验。
                  </p>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-[#f5f5f7] p-6 rounded-2xl text-center">
            ...
            <p className="text-sm text-gray-600">
              使用 Senela Trade In 换购服务，以旧换新，购新更省钱。
            </p>
          </div>
        </div>
      </div>
